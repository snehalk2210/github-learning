                  ...
                  <?php for($i=0;$i<count($rs);$i++){?>                                    <option value="<?php echo $rs[$i]['veg_id'];?>"><?php echo $rs[$i]['veg_name'];?></option>
                   <?php }?>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Vegetable Unit</label>
                                                            </div>
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                <div class="form-select-list">
                                                              <select type="text" name="veg_unit" id="veg_unit" class="form-control" >
                                                              	
                    <option>--select vegetable unit--</option>
                    <?php for($i=0;$i<count($veg_unit);$i++){
                    	?>
                    <option value="<?php echo $veg_unit[$i]['vunit_id']?>"><?php echo $veg_unit[$i]['vunit_unit'];?></option>                                          	
                    <?php }?>
                                                              </select>     
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Vegetable Rate</label>
                                                            </div>
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                <div class="form-select-list">
