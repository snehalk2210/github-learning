...
<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="basic-login-inner">
                                               ...
                                               <!--<form method="post" name="frm" id="frm" action="<?php echo base_url().'User/add_user_details'?>">-->
                                               <?php echo form_open('User/add_user_details');?>
				...
				<?php 
				for($i=0;$i<count($types);$i++){?>								<option value="<?php echo $types[$i]['user_type_id'];?>"><?php echo $types[$i]['user_type'];?></option>
