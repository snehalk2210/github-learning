                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="basic-login-inner">
                                                ...
                                                <form method="post" name="frm" id="frm" action="<?php echo base_url().'User/add_type_action'?>">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                <textarea type="text" name="desc"  id="desc" class="form-control" placeholder="Enter description " ></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
