<form action="<?php echo base_url().'Orders/add_order_action';?>" method="post" name="frm" id="frm">
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    ...
    <label class="login2 pull-right pull-right-pro">Select Customer</label>
    </div>
<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
  <div class="form-select-list">
<select class="form-control custom-select-value" name="sel_user" id="sel_user" >
																	<option value="">--Select User-- </option>
			<?php for($i=0;$i<count($result);$i++)
			{
				?>
				
		<option value="<?php echo $result[$i]['user_id'];?>"><?php echo $result[$i]['user_name']?></option>
																			<?php } ?>
